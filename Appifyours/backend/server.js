...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/dey_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '690c4bc838cb8b41aac92705',
      shopName: 'dey',
...
app.listen(PORT, () => {
  console.log(`dey Backend Server running on port ${PORT}`);
});
